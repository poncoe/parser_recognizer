...
bool isiObjek(myStack &S) {
    ...
    } else if (info(top(S)) == 'G' || info(top(S)) == 'g') {
        pop(S, P);
        if (info(top(S)) == 'A' || info(top(S)) == 'a') {
            pop(S, P);
            if (info(top(S)) == 'M' || info(top(S)) == 'm') {
    ...
    } else if (info(top(S)) == 'C' || info(top(S)) == 'c') {
        pop(S, P);
...
bool cekKalimat(myStack &S1, myStack &S2, myStack &S3, myStack &S4, myStack &S5) {
    if (!isEmpty(S1) && isiSubjek(S1)) {
        if (!isEmpty(S2) && isiPredikat(S2)) {
            if (!isEmpty(S3) && isiObjek(S3)) {
                if (!isEmpty(S4) && isEmpty(S5) && isiKeterangan(S4)) {
                    return true;
                } else if (isEmpty(S4) && isEmpty(S5)) {
                    return true;
                }
            } else if (!isEmpty(S3) && isiKeterangan(S3)) {
